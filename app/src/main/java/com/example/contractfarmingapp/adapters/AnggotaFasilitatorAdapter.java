...
import com.example.contractfarmingapp.ChatActivityDariFasilitator;
import com.example.contractfarmingapp.R;
import com.example.contractfarmingapp.models.AnggotaModel;

import java.util.List;

public class AnggotaFasilitatorAdapter extends RecyclerView.Adapter<AnggotaFasilitatorAdapter.ViewHolder> {
    ...
    public AnggotaFasilitatorAdapter(Context context, List<AnggotaModel> anggotaList, String userPeran, OnAnggotaDeleteListener deleteListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(context, ChatActivityDariFasilitator.class);
