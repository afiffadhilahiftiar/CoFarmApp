...
public class ChatActivityPetaniOfftaker extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        int userIdStr = prefs.getInt("id", -1); // default -1 kalau tidak ada
        String companyId = getIntent().getStringExtra("oftaker_id");
        ...
        namaAdmin.setText("Chat dengan " + (nama != null ? nama : "Offtaker"));
        ...
        pollingTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                if (isActivityVisible && !isFinishing()) {
                    runOnUiThread(ChatActivityPetaniOfftaker.this::loadMessages);
                }
            }
        }, 0, 2000); // 2 detik
    }
