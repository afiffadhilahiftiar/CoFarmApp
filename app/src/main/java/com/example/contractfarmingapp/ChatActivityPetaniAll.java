...
public class ChatActivityPetaniAll extends AppCompatActivity {
    ...
    private void uploadFile(Uri fileUri) {
        ...
        try {
            ...
            String url = ApiConfig.BASE_URL + "upload_file_petani_all.php";
    ...
    private void sendMessage() {
        ...
        String url = ApiConfig.BASE_URL + "send_message_all.php";
        ...
        pollingTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                if (isActivityVisible && !isFinishing()) {
                    runOnUiThread(ChatActivityPetaniAll.this::loadMessages);
                }
            }
