...
import com.example.contractfarmingapp.adapters.AnggotaFasilitatorAdapter;
...
public class DaftarAnggotaFasilitatorActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private Button btnTambahAnggota;
    private AnggotaFasilitatorAdapter adapter;
    ...
    private static final String URL_GET_ANGGOTA = ApiConfig.BASE_URL + "get_anggota_fasilitator.php?company_id=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userId = sharedPreferences.getString("user_id", "");           // default "" jika tidak ada
        companyId = sharedPreferences.getString("company_id", "");
        lokasi = sharedPreferences.getString("lokasi", "");
        fasilitatorId = sharedPreferences.getString("fasilitator_id", "");

        // Contoh penggunaan
        Log.d("DaftarFasilitator", "user_id: " + userId);
        Log.d("DaftarFasilitator", "company_id: " + companyId);
        Log.d("DaftarFasilitator", "lokasi: " + lokasi);
        Log.d("DaftarFasilitator", "fasilitator_id: " + fasilitatorId);
        ...
        adapter = new AnggotaFasilitatorAdapter(this, anggotaList, userPeran, (anggota, position) -> {
        ...
        btnTambahAnggota.setOnClickListener(v -> {
            Intent intent = new Intent(DaftarAnggotaFasilitatorActivity.this, TambahAnggotaActivity.class);
