...
public class DaftarChatPetaniAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new ChatPetaniAdapter(chatList, item -> {
            Intent intent = new Intent(DaftarChatPetaniAllActivity.this, ChatActivityPetaniAll.class);
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(DaftarChatPetaniAllActivity.this, "ID petani tidak valid", Toast.LENGTH_SHORT).show();
    ...
    private void loadChats() {
        String url =  ApiConfig.BASE_URL + "get_messages_for_company.php?company_id=" + userId;
