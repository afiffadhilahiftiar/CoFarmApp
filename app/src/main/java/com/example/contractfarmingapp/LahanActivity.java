...
// Aksi saat tombol ditekan
        btnPeta.setOnClickListener(v -> {
            Intent intent = new Intent(LahanActivity.this, MapViewGeofencingActivity.class);
        ...
        btnTambahLahan.setOnClickListener(v -> {
            Intent intent = new Intent(LahanActivity.this, MapGeofencingActivity.class);
            intent.putExtra("company_id", companyId);
            startActivityForResult(intent, 1001);
        });
        if (!"fasilitator".equalsIgnoreCase(peran)) {
            btnTambahLahan.setVisibility(Button.VISIBLE);
            switchFilterCompany.setVisibility(Button.GONE);
            Toast.makeText(this, "Peran Anda: " + peran, Toast.LENGTH_SHORT).show();
        }
