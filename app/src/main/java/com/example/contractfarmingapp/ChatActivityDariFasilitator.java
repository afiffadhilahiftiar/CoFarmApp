...
public class ChatActivityDariFasilitator extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String companyIdStr = sharedPreferences.getString("fasilitator_id", null);
        ...
        String nama = getIntent().getStringExtra("nama_petani");
    ...
    private void uploadFile(Uri fileUri) {
        ...
        try {
            ...
            String url = ApiConfig.BASE_URL + "upload_file_petani.php";
    ...
    private void sendMessage() {
        ...
        String url = ApiConfig.BASE_URL + "send_message.php";
        ...
        pollingTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                if (isActivityVisible && !isFinishing()) {
                    runOnUiThread(ChatActivityDariFasilitator.this::loadMessages);
                }
            }
